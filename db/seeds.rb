...
test1 = Test.create(title: 'Ruby', category_id: category3.id, creator_id: user3.id)
test2 = Test.create(title: 'Rails', category_id: category3.id, creator_id: user3.id, level: 3)
test3 = Test.create(title: 'Postgres', category_id: category2.id, creator_id: user3.id, level: 2)
test4 = Test.create(title: 'HTTP', category_id: category1.id, creator_id: user3.id, level: 6)
...
tests_user1 = TestsUser.create(user_id: user1.id, test_id: test1.id)
tests_user2 = TestsUser.create(user_id: user1.id, test_id: test2.id)
tests_user3 = TestsUser.create(user_id: user1.id, test_id: test3.id)
tests_user4 = TestsUser.create(user_id: user2.id, test_id: test1.id)
